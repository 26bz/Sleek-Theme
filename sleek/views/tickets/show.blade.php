<div class="space-y-6">
    Breadcrumb Navigation <x-navigation.breadcrumb />

    Ticket Header <div class="flex flex-col sm:flex-row justify-between items-start gap-4">
        <div>
        ...
        <div class="flex flex-wrap items-center gap-2">
            Status Badge @if ($ticket->status == 'open')
                <span
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
        Ticket Details Sidebar <div class="lg:order-last order-first">
            <div
        ...
        Messages and Reply Form <div class="lg:col-span-3 space-y-6">
            Messages <div class="bg-background-secondary border border-neutral/20 rounded-lg shadow-sm overflow-hidden">
                    ...
                    <div class="flex flex-col gap-4 max-h-[60vh] overflow-y-auto pr-2" wire:poll.10s>
                        @foreach ($ticket->messages()->with('user')->get() as $message)
                            <div
                                ...
                                User Avatar <div class="flex-shrink-0">
                                    <div
                                ...
                                Message Content <div
                                    ...
                                    Message Header <div class="flex items-center justify-between mb-2">
                                        <div>
                                            <div class="flex items-center gap-2">
                                                <h3 class="font-medium">{{ $message->user->name }}</h3>

                                                User or Staff Badge @if ($message->user_id !== $ticket->user_id)
                                                    <span
                                    ...
                                    Message Content <div
                                        class="prose dark:prose-invert prose-sm max-w-none break-words mt-3">
                                    ...
                                    Attachments @if (count($message->attachments) > 0)
            ...
            Reply Form <div
                class="bg-background-secondary border border-neutral/20 rounded-xl shadow-sm overflow-hidden">
                <div class="border-b border-neutral/10 p-4 bg-neutral/5">
                ...
                <div class="p-6">
                    <form wire:submit.prevent="save" wire:ignore>
                        Editor <div
                            class="editor-container border border-neutral/20 rounded-lg overflow-hidden shadow-sm">
                            <textarea id="editor" placeholder="Type your reply here..."></textarea>
                        </div>

                        Attachments <div class="mt-5">
                        ...
                        Submit Button <div class="mt-6 flex justify-end">
